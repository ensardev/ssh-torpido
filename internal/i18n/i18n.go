...
var dicts = map[Lang]Strings{
	EN: {
		...
		LHumanWaitingFmt: "%s · %d/2 waiting",
		LFooter:          "↑↓ select · enter join · c create · h quick match · k join by code · q quit",
		LCode:            "CODE: ",
	...
	TR: {
		...
		LHumanWaitingFmt: "%s · %d/2 bekliyor",
		LFooter:          "↑↓ seç · enter gir · c oda kur · h hızlı eşleş · k kodla katıl · q çık",
		LCode:            "KOD: ",
